# Migration Registry Archive — copilot-instructions-template

> Use this archive with `MIGRATION.md` when the installed version is earlier than `v3.4.0`.
> `MIGRATION.md` remains the active registry for `v3.4.0+` and for new release stubs.
