...
> Skill metadata: version "1.0"; license MIT; tags [typescript, security, xss, input-validation, owasp]; recommended tools [codebase, editFiles].

## When to use

- Reviewing TypeScript/Node.js code for security vulnerabilities
- Writing security-sensitive code (auth, input handling, API boundaries)
