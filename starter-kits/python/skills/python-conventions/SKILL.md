...
> Skill metadata: version "1.0"; license MIT; tags [python, pep8, conventions, packaging]; recommended tools [codebase, editFiles].

## When to use

- Writing or reviewing Python source files
- Enforcing PEP 8 style and Python packaging conventions
