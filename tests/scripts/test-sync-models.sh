#!/usr/bin/env bash
# tests/scripts/test-sync-models.sh -- contract tests for scripts/sync/sync-models.sh
# Run: bash tests/scripts/test-sync-models.sh
...
init_test_context "$0"
SCRIPT="$REPO_ROOT/scripts/sync/sync-models.sh"
...
assert_contains "invalid mode prints usage" "$output" "Usage: bash scripts/sync/sync-models.sh"
echo ""
