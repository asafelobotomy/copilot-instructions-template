#!/usr/bin/env bash
# tests/test-workspace-drift.sh -- tests for scripts/check-workspace-drift.sh
# Run: bash tests/test-workspace-drift.sh
...
init_test_context "$0"
SCRIPT="$REPO_ROOT/scripts/check-workspace-drift.sh"
