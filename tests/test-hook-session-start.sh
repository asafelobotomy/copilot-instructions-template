#!/usr/bin/env bash
# tests/test-hook-session-start.sh -- unit tests for template/hooks/scripts/session-start.sh
# Run: bash tests/test-hook-session-start.sh
...
init_test_context "$0"
SCRIPT="$REPO_ROOT/template/hooks/scripts/session-start.sh"
