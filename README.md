...
<h1>Lean/Kaizen Copilot Instructions Template</h1>
  ...
  **A versioned VS Code agent plugin that keeps AI developer behaviour consistent across all your projects.**
  ...
  [![Version](https://img.shields.io/badge/version-0.7.0-blue)](CHANGELOG.md) <!-- x-release-please-version -->
...
Current template version: **0.7.0** <!-- x-release-please-version --> — see [CHANGELOG.md](CHANGELOG.md).
